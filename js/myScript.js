$('#add').click(function(event){
	...
	if(todoText === ""){
		...
		$('ul').append('<li class="cc"> <p class="bold">' + todoText + '</p> <div class = "cont"> <button class="check btn btn-primary"> check </button> <button class ="delete btn btn-danger"> delete </button> </div> </li>');
	}
});
